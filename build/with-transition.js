...
function withTransitions(Component) {var
  SemanticTransition = /*#__PURE__*/function (_React$Component) {_inherits(SemanticTransition, _React$Component);var _super = _createSuper(SemanticTransition);function SemanticTransition() {var _this;_classCallCheck(this, SemanticTransition);for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}_this = _super.call.apply(_super, [this].concat(args));_defineProperty(_assertThisInitialized(_this), "state",
      ...
      function () {
        ...
        this.setState({ visible: true });} }, { key: "render", value: function render() {
        var _this$props = this.props,toastId = _this$props.toastId,openAnimation = _this$props.openAnimation,closeAnimation = _this$props.closeAnimation,timeProp = _this$props.time,onClose = _this$props.onClose,props = _objectWithoutProperties(_this$props, _excluded);
        var _this$state = this.state,time = _this$state.time,visible = _this$state.visible,animation = _this$state.animation;
        var styles = {
          marginBottom: '1em' };


        return /*#__PURE__*/(
          _react["default"].createElement(_semanticUiReact.Transition, { animation: animation, duration: time, visible: visible }, /*#__PURE__*/
          _react["default"].createElement("div", { style: styles, role: "presentation" }, /*#__PURE__*/
